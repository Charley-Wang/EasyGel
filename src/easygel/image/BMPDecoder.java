     ...
     private int readInt() throws IOException {
        ...
        void getBitmapHeader() throws IOException {
                ...
                if (colorsUsed != 0)
                   ...
                   if(isbmp==true){
                        ...
                        bmp.sizeOfBitmap =sizeOfBitmap;
                        bmp.horzResolution =horzResolution;
                        bmp.vertResolution =vertResolution;
                        bmp.colorsUsed =colorsUsed;
                        bmp.colorsImportant =colorsImportant;
                        bmp.actualColorsUsed =actualColorsUsed;
                   }
        }
        ...
        void getPalette() throws IOException {
                ...
                if (noOfEntries>0) {
                   ...
                   if(isbmp==true){
                        bmp.r=new byte[bmp.actualColorsUsed ];
                        bmp.g=new byte[bmp.actualColorsUsed ];
                        bmp.b=new byte[bmp.actualColorsUsed ];
                        bmp.r =r;
                        bmp.g =g;
                        bmp.b =b;
                   }
        ...
        public  Image getImage(String directory,String name){
             String path = directory + name;
             //BMPDecoder bmp2 = new BMPDecoder();
             FileInputStream  is = null;
            try {
                 is = new FileInputStream(path);
                 /*
                 bmp2.read(is);
                 MemoryImageSource mis = bmp2.makeImageSource();
                if (mis==null) IJ.write("mis=null");
                 img = Toolkit.getDefaultToolkit().createImage(mis);
                this.bmp=bmp2.getBmp() ;
                 */
                 read(is);
                 MemoryImageSource mis = makeImageSource();
                if (mis==null) IJ.write("mis=null");
                 img = Toolkit.getDefaultToolkit().createImage(mis);
                 //this.bmp=bmp2.getBmp() ;
                return img;
